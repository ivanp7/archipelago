    ...
    bool fd_set = false, stride_set = false, alignment_set = false;
    {
        archi_plist_param_t parsed[] = {
            ...
            {.name = "params",
                ...
                .assign = {archi_plist_assign__value, &file_map_params, sizeof(file_map_params), NULL}},
            {.name = "size",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, size_t)}},
                .assign = {archi_plist_assign__value, &file_map_params.size, sizeof(file_map_params.size), NULL}},
            {.name = "offset",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, size_t)}},
                .assign = {archi_plist_assign__value, &file_map_params.offset, sizeof(file_map_params.offset), NULL}},
            {.name = "ptr_support",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &file_map_params.ptr_support, sizeof(file_map_params.ptr_support), NULL}},
            {.name = "readable",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &file_map_params.readable, sizeof(file_map_params.readable), NULL}},
            {.name = "writable",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &file_map_params.writable, sizeof(file_map_params.writable), NULL}},
            {.name = "shared",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &file_map_params.shared, sizeof(file_map_params.shared), NULL}},
            {.name = "flags",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, int)}},
                .assign = {archi_plist_assign__value, &file_map_params.flags, sizeof(file_map_params.flags), NULL}},
            {0},
        };
