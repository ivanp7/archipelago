    ...
    bool pathname_set = false, fd_set = false;
    {
        archi_plist_param_t parsed[] = {
            ...
            {.name = "params",
                ...
                .assign = {archi_plist_assign__value, &file_open_params, sizeof(file_open_params), NULL}},
            {.name = "size",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, size_t)}},
                .assign = {archi_plist_assign__value, &file_open_params.size, sizeof(file_open_params.size), NULL}},
            {.name = "readable",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &file_open_params.readable, sizeof(file_open_params.readable), NULL}},
            {.name = "writable",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &file_open_params.writable, sizeof(file_open_params.writable), NULL}},
            {.name = "create",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &file_open_params.create, sizeof(file_open_params.create), NULL}},
            {.name = "exclusive",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &file_open_params.exclusive, sizeof(file_open_params.exclusive), NULL}},
            {.name = "truncate",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &file_open_params.truncate, sizeof(file_open_params.truncate), NULL}},
            {.name = "append",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &file_open_params.append, sizeof(file_open_params.append), NULL}},
            {.name = "flags",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, int)}},
                .assign = {archi_plist_assign__value, &file_open_params.flags, sizeof(file_open_params.flags), NULL}},
            {.name = "mode",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, int)}},
                .assign = {archi_plist_assign__value, &file_open_params.mode, sizeof(file_open_params.mode), NULL}},
            {.name = "stream",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &stream, sizeof(stream), NULL}},
            {0},
        };
