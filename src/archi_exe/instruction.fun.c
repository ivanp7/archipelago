...
#define INSTRUCTION(type, name)                                                 \
        case ARCHI_EXE_REGISTRY_INSTR__##type:                                  \
            return archi_exe_registry_instr_execute__##name(registry,           \
...
static
void
archi_exe_registry_instr_print__delete(
        const archi_exe_registry_instr__delete_t *instruction)
{
...
static
void
archi_exe_registry_instr_print__copy(
        const archi_exe_registry_instr__copy_t *instruction)
{
    archi_print_key("key", instruction->key);
...
static
void
archi_exe_registry_instr_print__init_parameters(
        const archi_exe_registry_instr__init_parameters_t *instruction)
{
    archi_print_key("key", instruction->key);
...
static
void
archi_exe_registry_instr_print__init_pointer(
        const archi_exe_registry_instr__init_pointer_t *instruction)
{
    archi_print_key("key", instruction->key);
    {
...
static
void
archi_exe_registry_instr_print__init_array(
        const archi_exe_registry_instr__init_array_t *instruction)
{
    archi_print_key("key", instruction->key);
    {
...
static
void
archi_exe_registry_instr_print__init_from_context(
        const archi_exe_registry_instr__init_from_context_t *instruction)
{
    archi_print_key("key", instruction->key);
...
static
void
archi_exe_registry_instr_print__init_from_slot(
        const archi_exe_registry_instr__init_from_slot_t *instruction)
{
    archi_print_key("key", instruction->key);
    archi_print_key("interface_origin_key", instruction->interface_origin_key);
...
static
void
archi_exe_registry_instr_print__set_to_value(
        const archi_exe_registry_instr__set_to_value_t *instruction)
{
    archi_print_key("key", instruction->key);
...
static
void
archi_exe_registry_instr_print__set_to_context_data(
        const archi_exe_registry_instr__set_to_context_data_t *instruction)
{
    archi_print_key("key", instruction->key);
    archi_print_slot("slot", instruction->slot);
...
static
void
archi_exe_registry_instr_print__set_to_context_slot(
        const archi_exe_registry_instr__set_to_context_slot_t *instruction)
{
    archi_print_key("key", instruction->key);
    archi_print_slot("slot", instruction->slot);
...
static
void
archi_exe_registry_instr_print__act(
        const archi_exe_registry_instr__act_t *instruction)
{
    archi_print_key("key", instruction->key);
...
archi_exe_registry_instr_print(
        const struct archi_exe_registry_instr_base *instruction,
        size_t instruction_number)
{
    ...
    if (instruction_number > 0)
        archi_print("#%zu ", instruction_number);

    switch (instruction->type)
    {
        case ARCHI_EXE_REGISTRY_INSTR__NOOP:
            archi_print("[NOOP]\n");
            break;
...
#define INSTRUCTION(type, name)                                                 \
        case ARCHI_EXE_REGISTRY_INSTR__##type:                                  \
            archi_print("[" #type "]\n");                                       \
            archi_exe_registry_instr_print__##name(                             \
                    (const archi_exe_registry_instr__##name##_t*)instruction);  \
            break
...
#undef INSTRUCTION
        ...
        default:
            archi_print("[instruction type %i]\n", instruction->type);
    }
}
