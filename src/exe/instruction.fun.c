        ...
        bool logging)
{
    ...
    if (logging)
    {
        ...
        archi_print_key_interface("interface_source_key", instruction->interface_source_key);
    ...
    else if (instruction->interface_source_key[0] == '\0') // pointer copy
        interface_value = (archi_pointer_t){
