...
/**
 * @file
 * @brief Types for string utilities.
 */

#pragma once
#ifndef _ARCHI_BASE_UTIL_STRING_TYP_H_
#define _ARCHI_BASE_UTIL_STRING_TYP_H_

/**
 * @brief Signature of a string comparison function.
 *
 ...
 */
#define ARCHI_STRING_COMP_FUNC(func_name)  int func_name( \
 ...
 */
typedef ARCHI_STRING_COMP_FUNC((*archi_string_comp_func_t));

#endif // _ARCHI_BASE_UTIL_STRING_TYP_H_
