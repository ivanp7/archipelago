...
#pragma once
#ifndef _ARCHI_BASE_UTIL_STRING_FUN_H_
#define _ARCHI_BASE_UTIL_STRING_FUN_H_
...
char*
archi_string_concat(
        const char *strings[], ///< [in] Array of strings to concatenate.
        size_t num_strings, ///< [in] Length of array of strings.
        const char *separator ///< [in] Separator string.
);
...
#endif // _ARCHI_BASE_UTIL_STRING_FUN_H_
