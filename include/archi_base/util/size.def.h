...
#pragma once
#ifndef _ARCHI_BASE_UTIL_SIZE_DEF_H_
#define _ARCHI_BASE_UTIL_SIZE_DEF_H_
 ...
 *
 * @note @p stride must be non-zero.
 *
...
/**
 * @def ARCHI_ALIGNMENT_VALID(alignment)
 * @brief Check if alignment requirement had valid value.
 *
 * @param alignment Alignment requirement in bytes.
 *
 * @return True if the alignment is valid, otherwise false.
 */
#define ARCHI_ALIGNMENT_VALID(alignment)    \
    (((alignment) != 0) && (((alignment) & ((alignment) - 1)) == 0))

#endif // _ARCHI_BASE_UTIL_SIZE_DEF_H_
