...
#pragma once
#ifndef _ARCHI_THREAD_HSP_CTX_DISPATCH_DATA_VAR_H_
#define _ARCHI_THREAD_HSP_CTX_DISPATCH_DATA_VAR_H_

#include "archi/context/api/interface.typ.h"

/**
 * @brief Context interface: data of HSP state for thread group dispatch.
 *
...
archi_context_interface__hsp_state_data__thread_group_dispatch;

#endif // _ARCHI_THREAD_HSP_CTX_DISPATCH_DATA_VAR_H_
