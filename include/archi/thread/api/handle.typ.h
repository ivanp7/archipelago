...
/**
 * @file
 * @brief Handle types for concurrent processing.
 */

#pragma once
#ifndef _ARCHI_THREAD_API_HANDLE_TYP_H_
#define _ARCHI_THREAD_API_HANDLE_TYP_H_
...
#endif // _ARCHI_THREAD_API_HANDLE_TYP_H_
