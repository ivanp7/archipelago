...
#pragma once
#ifndef _ARCHI_THREAD_HSP_DISPATCH_TYP_H_
#define _ARCHI_THREAD_HSP_DISPATCH_TYP_H_
...
/**
 * @brief Parameters for archi_hsp_state_thread_group_dispatch().
 */
typedef struct archi_hsp_state_data__thread_group_dispatch {
...
} archi_hsp_state_data__thread_group_dispatch_t;

#endif // _ARCHI_THREAD_HSP_DISPATCH_TYP_H_
