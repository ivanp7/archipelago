...
#pragma once
#ifndef _ARCHI_MEMORY_HSP_CTX_COPY_DATA_VAR_H_
#define _ARCHI_MEMORY_HSP_CTX_COPY_DATA_VAR_H_
...
archi_context_interface__hsp_state_data__memory_map_copy_unmap;

#endif // _ARCHI_MEMORY_HSP_CTX_COPY_DATA_VAR_H_
