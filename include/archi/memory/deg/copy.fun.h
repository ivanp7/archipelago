...
#pragma once
#ifndef _ARCHI_MEMORY_DEG_COPY_FUN_H_
#define _ARCHI_MEMORY_DEG_COPY_FUN_H_

#include "archi/deg/api/node.typ.h"

/**
 * @brief DEG node function for copying data between two memory objects.
 *
 * Function data type: archi_deg_node_data__memory_map_copy_unmap_t.
 *
...
#endif // _ARCHI_MEMORY_DEG_COPY_FUN_H_
