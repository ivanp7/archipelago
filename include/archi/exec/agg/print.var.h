...
#pragma once
#ifndef _ARCHI_EXEC_AGG_PRINT_VAR_H_
#define _ARCHI_EXEC_AGG_PRINT_VAR_H_

#include "archi/aggr/agg/generic.typ.h"


/**
 * @brief Aggregate type description for archi_dexgraph_op_data__print_string__token_t.
 */
extern
