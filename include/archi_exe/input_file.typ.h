...
#pragma once
#ifndef _ARCHI_EXE_INPUT_FILE_TYP_H_
#define _ARCHI_EXE_INPUT_FILE_TYP_H_

#include "archi/file/api/header.typ.h"
#include "archipelago/base/kvlist.typ.h"

#define ARCHI_EXE_INPUT_FILE_MAGIC  "[archi]" ///< Magic bytes identifying the format of input files.

/**
 * @brief Description of an input file for the executable.
 *
 * @note Valid input files always have `magic` containing the same bytes as ARCHI_EXE_INPUT_FILE_MAGIC.
 */
...
#endif // _ARCHI_EXE_INPUT_FILE_TYP_H_
