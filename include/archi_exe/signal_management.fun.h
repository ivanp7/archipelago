...
#pragma once
#ifndef _ARCHI_EXE_SIGNAL_MANAGEMENT_FUN_H_
#define _ARCHI_EXE_SIGNAL_MANAGEMENT_FUN_H_
...
archi_exe_signal_management_start(
        archi_signal_watch_set_t *signals,     ///< [in] Signals to watch.
...
#endif // _ARCHI_EXE_SIGNAL_MANAGEMENT_FUN_H_
