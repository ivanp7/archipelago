    ...
    const char *lflags = NULL;
    {
        ...
        archi_plist_param_t parsed[] = {
            ...
            {.name = "device_id",
                ...
                .assign = {archi_plist_assign__rcpointer, &device_ids, sizeof(device_ids)}},
            {.name = "headers",
                ...
                .assign = {archi_plist_assign__dptr, &list_headers, sizeof(list_headers)}},
            {.name = "sources",
                .check = {archi_value_check__attrs, (archi_pointer_attr_t[]){-1, archi_pointer_attr__cdata(ARCHI_POINTER_DATA_TAG__KVLIST),
                archi_pointer_attr__cdata(ARCHI_POINTER_DATA_TAG__KRCVLIST), -1}},
                .assign = {archi_plist_assign__dptr, &list_sources, sizeof(list_sources)}},
            {.name = "libraries",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(0, cl_program)}},
                .assign = {archi_plist_assign__rcpointer, &library_programs, sizeof(library_programs)}},
            {.name = "cflags",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(0, char)}},
                .assign = {archi_plist_assign__dptr_n, &cflags, sizeof(cflags)}},
            {.name = "lflags",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(0, char)}},
                .assign = {archi_plist_assign__dptr_n, &lflags, sizeof(lflags)}},
            {0},
        };
    ...
    bool build = false;
    {
        ...
        archi_plist_param_t parsed[] = {
            ...
            {.name = "binaries",
                ...
                .assign = {archi_plist_assign__rcpointer, &array_binaries, sizeof(array_binaries)}},
            {.name = "binary_sizes",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, size_t)}},
                .assign = {archi_plist_assign__rcpointer, &array_binary_sizes, sizeof(array_binary_sizes)}},
            {.name = "build",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &build, sizeof(build)}},
            {0},
        };
