...
#pragma once
#ifndef _ARCHI_SDL2_AGG_RENDER_VAR_H_
#define _ARCHI_SDL2_AGG_RENDER_VAR_H_

#include "archi/aggr/agg/generic.typ.h"


/**
 * @brief Aggregate type description for SDL_Rect.
 */
extern
const archi_aggr_type_t
archi_aggr_type__sdl2_rect;

/**
 * @brief Aggregate type description for archi_dexgraph_op_data__sdl2_texture_copy_t.
 */
extern
const archi_aggr_type_t
