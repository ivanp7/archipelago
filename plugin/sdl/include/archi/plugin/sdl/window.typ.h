...
#pragma once
#ifndef _ARCHI_PLUGIN_SDL_WINDOW_TYP_H_
#define _ARCHI_PLUGIN_SDL_WINDOW_TYP_H_
 ...
 */
#define ARCHIP_SDL_LIBRARY_CONFIG_KEY_FLAGS "flags"

/**
 * @brief SDL library configuration key -- whether to initialize the timer subsystem.
 */
#define ARCHIP_SDL_LIBRARY_CONFIG_KEY_INIT_TIMER "timer"

/**
 * @brief SDL library configuration key -- whether to initialize the audio subsystem.
 */
#define ARCHIP_SDL_LIBRARY_CONFIG_KEY_INIT_AUDIO "audio"
 ...
 */
#define ARCHIP_SDL_LIBRARY_CONFIG_KEY_INIT_VIDEO "video"
 ...
 * Automatically initializes the events subsystem.
 */
#define ARCHIP_SDL_LIBRARY_CONFIG_KEY_INIT_JOYSTICK "joystick"

/**
 * @brief SDL library configuration key -- whether to initialize the haptic subsystem.
 */
#define ARCHIP_SDL_LIBRARY_CONFIG_KEY_INIT_HAPTIC "haptic"
 ...
 * Automatically initializes the events subsystem.
 */
#define ARCHIP_SDL_LIBRARY_CONFIG_KEY_INIT_GAMECONTROLLER "controller"

/**
 * @brief SDL library configuration key -- whether to initialize the events subsystem.
 */
#define ARCHIP_SDL_LIBRARY_CONFIG_KEY_INIT_EVENTS "events"

/**
 * @brief SDL library configuration key -- whether to initialize all subsystems.
 */
#define ARCHIP_SDL_LIBRARY_CONFIG_KEY_INIT_EVERYTHING "everything"
 ...
 */
#define ARCHIP_SDL_WINDOW_CONFIG_KEY "config"

/**
 * @brief SDL window configuration key -- texture width.
 */
#define ARCHIP_SDL_WINDOW_CONFIG_KEY_TEXTURE_WIDTH "texture_width"

/**
 * @brief SDL window configuration key --  height.
 */
#define ARCHIP_SDL_WINDOW_CONFIG_KEY_TEXTURE_HEIGHT "texture_height"

/**
 * @brief SDL window configuration key -- window width.
 */
#define ARCHIP_SDL_WINDOW_CONFIG_KEY_WINDOW_WIDTH "window_width"

/**
 * @brief SDL window configuration key -- window height.
 */
#define ARCHIP_SDL_WINDOW_CONFIG_KEY_WINDOW_HEIGHT "window_height"

/**
 * @brief SDL window configuration key -- window flags.
 */
#define ARCHIP_SDL_WINDOW_CONFIG_KEY_WINDOW_FLAGS "window_flags"

/**
 * @brief SDL window configuration key -- window title.
 */
#define ARCHIP_SDL_WINDOW_CONFIG_KEY_WINDOW_TITLE "window_title"

#endif // _ARCHI_PLUGIN_SDL_WINDOW_TYP_H_
