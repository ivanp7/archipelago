...
#pragma once
#ifndef _PLUGIN_SDL_WINDOW_FUN_H_
#define _PLUGIN_SDL_WINDOW_FUN_H_

#include "sdl/window.typ.h"
...
typedef uint32_t plugin_sdl_pixel_t; ///< Texture pixel color.
...
plugin_sdl_window_create(
        plugin_sdl_window_config_t config, ///< [in] Window configuration.
...
plugin_sdl_window_destroy(
        struct plugin_sdl_window_context *context ///< [in] Window to destroy.
);
...
plugin_sdl_window_lock_whole_texture(
        struct plugin_sdl_window_context *context ///< [in] Window context.
);
...
plugin_sdl_window_texture_draw_glyph(
        ...
        plugin_sdl_pixel_t fg, ///< [in] Foreground color of glyph.
        plugin_sdl_pixel_t bg, ///< [in] Background color of glyph.
...
#endif // _PLUGIN_SDL_WINDOW_FUN_H_
