    ...
    bool driver_index_set = false;
    {
        archi_plist_param_t parsed[] = {
            {.name = "window",
                ...
                .assign = {archi_plist_assign__rcpointer, &window, sizeof(window)}},
            {.name = "driver_index",
            ...
            {.name = "software",
                ...
                .assign = {archi_plist_assign__bool, &software, sizeof(software)}},
            {.name = "accelerated",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &accelerated, sizeof(accelerated)}},
            {.name = "present_vsync",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &present_vsync, sizeof(present_vsync)}},
            {.name = "target_texture",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &target_texture, sizeof(target_texture)}},
            {.name = "flags",
