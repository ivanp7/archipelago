    ...
    bool width_set = false, height_set = false;
    {
        archi_plist_param_t parsed[] = {
            {.name = "renderer",
                ...
                .assign = {archi_plist_assign__rcpointer, &renderer, sizeof(renderer)}},
            {.name = "width",
            ...
            {.name = "pixel_format",
                ...
                .assign = {archi_plist_assign__dptr, &pixel_format_name, sizeof(pixel_format_name)}},
            {.name = "static",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &access_static, sizeof(access_static)}},
            {.name = "streaming",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &access_streaming, sizeof(access_streaming)}},
            {.name = "target",
                .check = {archi_value_check__attr, (archi_pointer_attr_t[]){ARCHI_POINTER_ATTR__PDATA(1, char)}},
                .assign = {archi_plist_assign__bool, &access_target, sizeof(access_target)}},
            {0},
        };
